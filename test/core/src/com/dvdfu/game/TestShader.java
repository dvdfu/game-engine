...
public class TestShader implements Shader {
	...
	public void init() {
        ...
        u_normal = program.getUniformLocation("u_normal");

		texture = new Texture(Gdx.files.internal("tex.jpg"));
		normal = new Texture(Gdx.files.internal("normal.jpg"));
	}
	...
	public void render(Renderable renderable) {
		...
		program.setUniformf(u_color, 0.2f, 0.2f, 0.2f);
